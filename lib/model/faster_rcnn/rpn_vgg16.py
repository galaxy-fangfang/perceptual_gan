...
from model.faster_rcnn.rpn_faster_rcnn import _fasterRCNN
...
class vgg16(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    self.RCNN_base = nn.Sequential(*list(vgg.features._modules.values())[5:-1])
    ...
    self.downsample = nn.Sequential(
            nn.Conv2d(in_channels = 64, out_channels= 512, kernel_size = 3, stride = 1, padding = 1, bias = False),
